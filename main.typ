...
#import "@local/typst-bsuir-core:0.14.7": *
...
Рассчитываем напряжение холостого хода $U_(x x)$ на зажимах ветви 6–4 (рис.~@meg-xx-circuit).
...
// Составим систему уравнений для токов левой части схемы (I_156 и I_7):
